...
Once RDP connection was established (`xfreerdp /v:10.1.228.201 /u:Administrator /drive:trustme,/tmp/trustme +clipboard /cert:ignore`) - `TrustMe.exe` could be found on the desktop. I downloaded the file for offline analysis onto my REMnux VM and run strings against it:  
